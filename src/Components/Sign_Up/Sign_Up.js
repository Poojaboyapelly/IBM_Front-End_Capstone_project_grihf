         ...
         <form method="POST" onSubmit={register}>
           <div className="form-group">
            ...
            <div className="form-group">
                ...
                <input value={name} onChange={(e) => setPhone(e.target.value)} type="phone" name="phone" id="phone" className="form-control" placeholder="Enter your phone" aria-describedby="helpId" />
                {showerr && <div className="err" style={{ color: 'red' }}>{showerr}</div>}
            </div>
